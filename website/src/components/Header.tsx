  ...
  return (
    <header className="sticky top-0 z-50 bg-slate-950/90 backdrop-blur-xl border-b border-slate-800/80 text-white px-4 md:px-8 py-3.5 transition-all">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        ...
        <nav className="hidden md:flex items-center gap-6 text-xs font-display font-semibold text-slate-300">
          <a href="#how-it-works" className="hover:text-white transition-colors">How It Works</a>
          <a href="#active-postings" className="hover:text-white transition-colors">Live Bids</a>
          <a href="#top-sellers" className="hover:text-white transition-colors flex items-center gap-1">
            <span>Verified Sellers</span>
            <span className="bg-emerald-500/20 text-emerald-400 text-[9px] px-1.5 py-0.5 rounded-full border border-emerald-500/30">
              GST Verified
            </span>
          </a>
          <a href="#escrow-guarantee" className="hover:text-white transition-colors text-amber-400 flex items-center gap-1">
