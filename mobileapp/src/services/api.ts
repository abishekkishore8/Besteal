import { Requirement, Quote, Seller, Order, WalletTransaction, AppNotification, OrderDispute } from '../types';
...
export const api = {
  ...
  async getSellers(): Promise<Seller[]> {
    try {
      ...
      return [
        { id: 'SEL-001', name: 'Rajan Electronics', city: 'Bengaluru', biz: 'GST: 29AAAAA0000A1Z5 · Consumer Electronics', kyc: 'verified', level: 3, revenue: '₹4.8L', rating: 4.7, status: 'active', responseMin: 3.2, priceCompetitiveness: 94.8, walletBalance: 1240 },
      ];
    }
  },
